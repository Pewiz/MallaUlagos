...
import CarreraCard from "./CarreraCard.astro";
      ...
      <div className="flex flex-wrap gap-5 my-10 mx-2.5 justify-center min-h-[1110px] pb-[920px] min-[340px]:pb-[970px] min-[966px]:pb-[500px]">
        {filteredCarreras.length > 0 ? (
          filteredCarreras.map((carrera) => (
            <div class="rounded-lg shadow-md overflow-hidden transition-transform hover:scale-105 hover:shadow-xl w-80 max-h-[275px]">
              <div class="overflow-hidden relative h-full">
                ...
                >
                  <img
                    ...
                    loading="lazy"
                  />
                  <div class="bg-[#000000b0] absolute bottom-0 w-full h-20 z-30 flex items-center justify-center">
          ...
          <div className="w-full text-center py-20">
            <div className="max-w-md mx-auto">
              ...
              <p className="text-gray-500">
                Intenta ajustar los filtros de búsqueda o seleccionar un
